...
my $compara_dba = new Bio::EnsEMBL::Compara::DBSQL::DBAdaptor(-host=>'mysql-ens-compara-prod-3.ebi.ac.uk', -user=>'ensadmin', -pass=>'ensembl', -dbname=>'ggiroussens_pseudogenes_v9', -port=>4523);
